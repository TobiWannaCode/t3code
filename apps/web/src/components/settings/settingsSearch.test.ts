...
describe("searchSettings", () => {
  ...
  it.each([
    ...
    [".conventions.json", "repository-conventions", "/settings/conventions"],
    ["branch naming", "branch-naming", "/settings/conventions"],
    ["writing style", "source-control-writing-style", "/settings/conventions"],
    ["follow change request templates", "follow-change-request-templates", "/settings/conventions"],
