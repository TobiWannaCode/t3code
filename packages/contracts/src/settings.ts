...
export const ClientSettingsSchema = Schema.Struct({
  ...
  // default sidebar.
  sidebarLayout: Schema.Literals(["existing", "explorer"]).pipe(
    Schema.withDecodingDefault(Effect.succeed("existing" as const)),
  ),
...
export const ClientSettingsPatch = Schema.Struct({
  ...
  sidebarLayout: Schema.optionalKey(Schema.Literals(["existing", "explorer"])),
